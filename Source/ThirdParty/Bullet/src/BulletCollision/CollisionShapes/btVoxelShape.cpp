...
btVoxelShape::btVoxelShape(btVoxelContentProvider* contentProvider, int sizex, int sizey, int sizez, btScalar scaleFactor)
: m_contentProvider(contentProvider),
m_scaleFactor(scaleFactor),
m_collisionMargin(btScalar(0.)),
m_localScaling(btScalar(0.3),btScalar(0.3),btScalar(0.3))
{
	btVector3 size = size*scaleFactor;
	m_localAabbMin = btVector3(0, 0, 0);
