...
public:
    ...
    explicit btVoxelShape(btVoxelContentProvider *contentProvider, int sizex, int sizey, int sizez, btScalar scaleFactor);
	...
	virtual btScalar getScaleFactor() const {
